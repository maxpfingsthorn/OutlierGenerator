...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description='Convert a pair of original g2o file with corresponding outliers to a MaxMix graph, one maxmix per hypercomponent.')
