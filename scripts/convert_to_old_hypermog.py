...
class old_hypermog_output(G.base_g2o_output):
	def __init__(self,dim,null_weight):
		super(old_hypermog_output, self).__init__(dim)
	...
	def output_edge(self,i,e):
		...
		self.out.write( " %s %s %d" % (e.reference, e.motion_batches[0].target,  len(e.motion_batches)))
...
if __name__ == "__main__":
	...
	g.writeg2o(args.output,old_hypermog_output(g.dim, args.null_weight))
